...
function blackcart_import_files() {
    return array(
      array(
        ...
        'categories'                   => array( 'BlackCart','Free'),
      ...
      array(
        ...
        'local_import_file'            => trailingslashit( get_template_directory() ) .'inc/dummy-content/blackcart.xml',
        'local_import_customizer_file' => trailingslashit( get_template_directory() ) .'inc/dummy-content/blackcart.dat',
